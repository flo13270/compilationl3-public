...
public class Parser
{
    ...
    private void reduce_0(int reduction) throws IOException, LexerException, ParserException
    {
        switch(reduction)
        {
            ...
            break;
            case 59: /* reduce AFinalListeexpbis */
            {
                ArrayList<Object> list = new59();
                push(goTo(28), list, false);
            }
            break;
            case 60: /* reduce ARecursifListeexpbis */
            {
            ...
            break;
            case 62: /* reduce ASansparamAppelfct */
            {
    ...
    ArrayList<Object> new58() /* reduce AFinalListeexp */
    {
        ...
        plisteexpNode1 = new AFinalListeexp(pexpNode2);
        }
	nodeList.add(plisteexpNode1);
        return nodeList;
    }
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    ArrayList<Object> new59() /* reduce AFinalListeexpbis */
    {
        @SuppressWarnings("hiding") ArrayList<Object> nodeList = new ArrayList<Object>();
        ...
        plisteexpbisNode1 = new AFinalListeexpbis(tvirguleNode2, pexpNode3);
        }
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    ArrayList<Object> new60() /* reduce ARecursifListeexpbis */
    {
        @SuppressWarnings("hiding") ArrayList<Object> nodeList = new ArrayList<Object>();
    ...
    ArrayList<Object> new61() /* reduce AAvecparamAppelfct */
    {
        ...
        pappelfctNode1 = new AAvecparamAppelfct(tidentifNode2, tparentheseouvranteNode3, plisteexpNode4, tparenthesefermanteNode5);
        }
    ...
    @SuppressWarnings({ "unchecked", "rawtypes" })
    ArrayList<Object> new62() /* reduce ASansparamAppelfct */
    {
        @SuppressWarnings("hiding") ArrayList<Object> nodeList = new ArrayList<Object>();
        ...
        pappelfctNode1 = new ASansparamAppelfct(tidentifNode2, tparentheseouvranteNode3, tparenthesefermanteNode4);
        }
	nodeList.add(pappelfctNode1);
        return nodeList;
    }
...
/*      {
			...
			{{-1, ERROR, 63}, {5, SHIFT, 47}, {6, SHIFT, 84}, {15, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			...
			{{-1, REDUCE, 31}, },
			{{-1, ERROR, 69}, {6, SHIFT, 89}, {14, SHIFT, 72}, },
			{{-1, REDUCE, 48}, },
			{{-1, ERROR, 71}, {6, SHIFT, 90}, },
			...
			{{-1, REDUCE, 32}, },
			{{-1, ERROR, 83}, {6, SHIFT, 101}, {14, SHIFT, 72}, },
			{{-1, REDUCE, 62}, },
			{{-1, REDUCE, 58}, {0, SHIFT, 102}, {14, SHIFT, 72}, },
			{{-1, ERROR, 86}, {6, SHIFT, 104}, },
			{{-1, ERROR, 87}, {8, SHIFT, 105}, {14, SHIFT, 72}, },
			{{-1, ERROR, 88}, {2, SHIFT, 106}, {14, SHIFT, 72}, },
			{{-1, REDUCE, 53}, },
			{{-1, REDUCE, 54}, },
			{{-1, REDUCE, 35}, {13, SHIFT, 74}, },
			{{-1, REDUCE, 28}, {19, SHIFT, 107}, },
			...
			{{-1, REDUCE, 45}, },
			{{-1, REDUCE, 30}, },
			{{-1, ERROR, 101}, {2, SHIFT, 109}, },
			{{-1, ERROR, 102}, {5, SHIFT, 47}, {15, SHIFT, 48}, {24, SHIFT, 49}, {26, SHIFT, 50}, {27, SHIFT, 31}, },
			{{-1, REDUCE, 57}, },
			{{-1, REDUCE, 61}, },
			{{-1, REDUCE, 55}, },
			{{-1, REDUCE, 23}, },
			{{-1, ERROR, 107}, {9, SHIFT, 20}, },
			{{-1, REDUCE, 27}, },
			{{-1, REDUCE, 33}, },
			{{-1, REDUCE, 59}, {0, SHIFT, 102}, {14, SHIFT, 72}, },
			{{-1, REDUCE, 29}, },
			{{-1, REDUCE, 60}, },
        };*/
...
/*      {
			...
			{{-1, 32}, },
			{{-1, 33}, },
			{{-1, 34}, {11, 22}, {21, 44}, {73, 92}, {81, 100}, {107, 111}, },
			{{-1, 35}, {32, 65}, },
			{{-1, 36}, },
			{{-1, 108}, },
			{{-1, 37}, },
			...
			{{-1, 40}, },
			{{-1, 41}, },
			{{-1, 51}, {28, 60}, {29, 61}, {47, 69}, {62, 83}, {63, 85}, {64, 87}, {67, 88}, {102, 110}, },
			{{-1, 52}, {72, 91}, },
			{{-1, 53}, {74, 93}, },
			{{-1, 54}, {75, 94}, {76, 95}, },
			{{-1, 55}, {77, 96}, {78, 97}, },
			{{-1, 56}, {48, 70}, {79, 98}, {80, 99}, },
			{{-1, 57}, },
			{{-1, 58}, {20, 42}, {32, 42}, },
			{{-1, 86}, },
			{{-1, 103}, {110, 112}, },
