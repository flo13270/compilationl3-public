...
public final class AWhileWhileInstruction extends PWhileInstruction
{
    ...
    public Object clone()
    {
        return new AWhileWhileInstruction(
    ...
    {
        ((Analysis) sw).caseAWhileWhileInstruction(this);
    }
