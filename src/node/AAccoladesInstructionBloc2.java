...
public final class AAccoladesInstructionBloc2 extends PInstructionBloc2
{
    private TLCbr _lCbr_;
    private PInstructionList _instructionList_;
    private TRCbr _rCbr_;

    public AAccoladesInstructionBloc2()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAccoladesInstructionBloc2(
    ...
    {
        ((Analysis) sw).caseAAccoladesInstructionBloc2(this);
    }
