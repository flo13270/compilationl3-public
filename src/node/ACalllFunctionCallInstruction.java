...
public final class ACalllFunctionCallInstruction extends PFunctionCallInstruction
{
    private PFunctionCall _functionCall_;

    public ACalllFunctionCallInstruction()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACalllFunctionCallInstruction(
    ...
    {
        ((Analysis) sw).caseACalllFunctionCallInstruction(this);
    }
